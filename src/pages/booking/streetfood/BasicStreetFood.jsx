      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl max-w-3xl mx-auto text-gray-600">
            ...
            with a local guide in this 3-hour culinary adventure.
          </p>
        </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
              ...
              <ul className="space-y-4 text-gray-700">
                <li className="flex items-start gap-3">
                  ...
                  <span><strong>Gỏi Khô Bò + Nước Mía</strong> (2 options available)</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-green-500 mt-1">✓</span>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-800">Bánh Canh Cua</h3>
                    <p className="text-gray-600">Experience thick noodle soup with fresh crab</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Experience local nightlife at the flower market with beer, grilled squid, grilled rice paper, lemongrass beef skewers, and coconut ice cream</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div>
            <div className="bg-white rounded-2xl shadow-lg p-8 sticky top-8">
              ...
              <form onSubmit={handleBookingSubmit} className="space-y-6">
                ...
                >
                  Book Basic Street Food Tour - $29
                </button>
                ...
                <div className="border-t pt-4">
                  ...
                  <div className="flex justify-center">
                    <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
                      ...
                      <input type="hidden" name="item_name" value="Basic Street Food Tour - $29 per person" />
                      ...
                      <input type="hidden" name="cancel_return" value="https://saigonese-hangout.com/booking/streetfood/basic" />
